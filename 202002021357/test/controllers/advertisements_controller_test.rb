...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { a_image_link: @advertisement.a_image_link, a_link: @advertisement.a_link } }, as: :json
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { a_image_link: @advertisement.a_image_link, a_link: @advertisement.a_link } }, as: :json
    assert_response 200
  end
